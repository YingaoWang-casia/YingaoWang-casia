...
def write_stats_card(repos):
  ...
  <g transform="translate(36 52)"><path class="icon" d="M8 .8l2.2 4.5 5 .7-3.6 3.5.8 5-4.4-2.3-4.4 2.3.8-5L.8 6l5-.7L8 .8z"/><text x="30" y="11" class="label">Total Stars Earned:</text><text x="250" y="11" class="value">{values['stars']}</text></g>
  <g transform="translate(36 84)"><path class="icon" d="M3 4.5h10M3 8.5h10M3 12.5h10M2.5 1.8h11A1.7 1.7 0 0 1 15.2 3.5v10A1.7 1.7 0 0 1 13.5 15.2h-11A1.7 1.7 0 0 1 .8 13.5v-10A1.7 1.7 0 0 1 2.5 1.8z"/><text x="30" y="11" class="label">Tracked Repositories:</text><text x="250" y="11" class="value">{values['repos']}</text></g>
  <g transform="translate(36 116)"><path class="icon" d="M3.5 3.5v9M12.5 3.5v9M3.5 8h9M3.5 3.5a2 2 0 1 0 0 .1M12.5 3.5a2 2 0 1 0 0 .1M3.5 12.5a2 2 0 1 0 0 .1M12.5 12.5a2 2 0 1 0 0 .1"/><text x="30" y="11" class="label">Original Projects:</text><text x="250" y="11" class="value">{values['projects']}</text></g>
  <g transform="translate(36 148)"><path class="icon" d="M3 3.5h10v9H3zM5 15h6M6.5 12.5v2.5M9.5 12.5v2.5"/><text x="30" y="11" class="label">Repository Forks:</text><text x="250" y="11" class="value">{values['forks']}</text></g>
